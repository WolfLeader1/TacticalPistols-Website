...
<body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <ul class="navbar-nav mr-auto w-100 justify-content-end">
                        ...
                        <li class="nav-item">
                            <a class="nav-link page-scroll" href="#slider-area">Shotguns</a>
                        </li>
                        <li class="nav-item">
    ...
    <section id="shotguns" class="page-section">
        <div class="container">
            <div class="section-header">
                <h2 class="section-title">Shotguns</h2>
            </div>
            <div class="container page-cont">
                <h3 class="h-center">New Stock Awaiting Photos</h3>
                <p class="p-desc">
                    New stock awaiting photography including a mossberg jm930 full tactical class shotgun
                    ...
                    A DEPOSIT WILL RESERVE ANY ITEM.
                </p>
            </div>
        </div>
    </section>
